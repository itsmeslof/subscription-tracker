<div class="overflow-x-auto relative" x-show="filter === 'Active'" >
		...
		<tbody>
			@forelse ($subscriptions as $subscription)
				<tr class="bg-white hover:bg-slate-100">
					...
					<td scope="row" class="py-4 px-4"><span class="bg-slate-200 rounded-lg py-1 px-3 inline-block">{{ ucfirst($subscription->billingCycle->name) }}</span></td>
