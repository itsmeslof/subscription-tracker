    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div>
                ...
                <x-input id="email" class="block mt-1 w-full" type="email" name="email" value="admin@example.com" required disabled autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="password" class="block mt-1 w-full" type="password" name="password" value="password" disabled required autocomplete="current-password" />
            </div>
